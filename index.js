...
(function($PS) {
  ...
  var Vertical = (function () {
      function Vertical(value0) {
          this.value0 = value0;
      };
      Vertical.create = function (value0) {
          return new Vertical(value0);
      };
      return Vertical;
  })();
  var toVertical = function (v) {
      ...
      throw new Error("Failed pattern match at Direction (line 20, column 1 - line 20, column 51): " + [ v.constructor.name ]);
  };
  var toHorizontal = function (v) {
      if (v instanceof Horizontal) {
          return new Data_Maybe.Just(v.value0);
      };
      if (v instanceof Vertical) {
      ...
      throw new Error("Failed pattern match at Direction (line 16, column 1 - line 16, column 55): " + [ v.constructor.name ]);
  }; 
  var eqVDir = new Data_Eq.Eq(function (x) {
      return function (y) {
  ...
  var eqHDir = new Data_Eq.Eq(function (x) {
      return function (y) {
  ...
  exports["toHorizontal"] = toHorizontal;
  exports["toVertical"] = toVertical;
  exports["eqHDir"] = eqHDir;
  exports["eqVDir"] = eqVDir;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var getNewDirectionAndDist = function (dir) {
      return function (distValPx) {
          return function (widthOrHeight) {
              if (dir instanceof Direction.Horizontal && dir.value0 instanceof Direction.RightDir) {
                  var $34 = distValPx >= Data_Int.toNumber(widthOrHeight) - 100.0;
                  if ($34) {
                      return Control_Applicative.pure(Effect.applicativeEffect)(new Data_Tuple.Tuple(new Direction.Horizontal(Direction.LeftDir.value), distValPx));
                  };
                  return Control_Applicative.pure(Effect.applicativeEffect)(new Data_Tuple.Tuple(new Direction.Horizontal(Direction.RightDir.value), distValPx + 9.0));
              };
              if (dir instanceof Direction.Horizontal && dir.value0 instanceof Direction.LeftDir) {
                  var $36 = distValPx <= 0.0;
                  if ($36) {
                      return Control_Applicative.pure(Effect.applicativeEffect)(new Data_Tuple.Tuple(new Direction.Horizontal(Direction.RightDir.value), distValPx));
                  };
                  return Control_Applicative.pure(Effect.applicativeEffect)(new Data_Tuple.Tuple(new Direction.Horizontal(Direction.LeftDir.value), distValPx - 9.0));
              };
              if (dir instanceof Direction.Vertical && dir.value0 instanceof Direction.DownDir) {
                  var $38 = distValPx >= Data_Int.toNumber(widthOrHeight) - 100.0;
                  if ($38) {
                      return Control_Applicative.pure(Effect.applicativeEffect)(new Data_Tuple.Tuple(new Direction.Vertical(Direction.UpDir.value), distValPx));
                  };
                  return Control_Applicative.pure(Effect.applicativeEffect)(new Data_Tuple.Tuple(new Direction.Vertical(Direction.DownDir.value), distValPx + 9.0));
              };
              if (dir instanceof Direction.Vertical && dir.value0 instanceof Direction.UpDir) {
                  var $40 = distValPx <= 0.0;
                  if ($40) {
                      return Control_Applicative.pure(Effect.applicativeEffect)(new Data_Tuple.Tuple(new Direction.Vertical(Direction.DownDir.value), distValPx));
                  };
                  return Control_Applicative.pure(Effect.applicativeEffect)(new Data_Tuple.Tuple(new Direction.Vertical(Direction.UpDir.value), distValPx - 9.0));
              };
              throw new Error("Failed pattern match at Main (line 67, column 54 - line 79, column 85): " + [ dir.constructor.name ]);
          };
      };
  };
  ...
  var getColor = function (curColor) {
      ...
      return Data_Functor.map(Effect.functorEffect)((function () {
          var $83 = Data_Maybe.fromMaybe(defaultColor);
          var $84 = Data_Array.index(colors$prime);
          return function ($85) {
              return $83($84($85));
          };
          ...
          return function (el) {
              return function (stateRef) {
                  return function __do() {
                      ...
                      var v5 = Data_Functor.mapFlipped(Effect.functorEffect)(getNewDirectionAndDist(new Direction.Horizontal(hDir))(v.position.value0)(v3))(function (v5) {
                          return new Data_Tuple.Tuple(Data_Maybe.fromMaybe(Direction.RightDir.value)(Direction.toHorizontal(v5.value0)), v5.value1);
                      })();
                      var v6 = Data_Functor.mapFlipped(Effect.functorEffect)(getNewDirectionAndDist(new Direction.Vertical(vDir))(v.position.value1)(v4))(function (v6) {
                          return new Data_Tuple.Tuple(Data_Maybe.fromMaybe(Direction.DownDir.value)(Direction.toVertical(v6.value0)), v6.value1);
                      })();
                      var v7 = (function () {
                          var $56 = Data_Eq.notEq(Direction.eqHDir)(v5.value0)(hDir) || Data_Eq.notEq(Direction.eqVDir)(v6.value0)(vDir);
                          if ($56) {
                      ...
                      return Effect_Ref.write({
                          ...
                          dirVert: v6.value0,
                          isMoving: true,
                          position: new Data_Tuple.Tuple(v5.value1, v6.value1),
                          rafId: v9
                      })(stateRef)();
                  };
              };
  ...
  var main = function __do() {
      ...
      var b = Data_Maybe.maybe(Web_DOM_Element.toNode(v3))(Web_HTML_HTMLElement.toNode)(v2);
      ...
      var v9 = Web_Event_EventTarget.eventListener((function () {
          var $86 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit))(Data_Function.flip(toggleBoxMove)(v7));
          return function ($87) {
              return $86(Web_UIEvent_KeyboardEvent.fromEvent($87));
          };
      })())();
      return Web_Event_EventTarget.addEventListener("keydown")(v9)(false)(Web_HTML_Window.toEventTarget(v))();
  };
